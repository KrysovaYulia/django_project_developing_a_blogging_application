...
class PublishedManager(models.Manager):
    def get_queatyset(self):
        return super().get_quaryset().filter(status=Post.Status.PUBLISHED)
...
class Post(models.Model):
    ...
    author = models.ForeignKey(User, on_delete=models.CASCADE, related_name='blog_posts', verbose_name='Имя автора')
